...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./workspaces/Workplace_Attendance/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./workspaces/Workplace_Attendance/public/storage','fortify.guard',
...
'password.confirm.store','home','dashboard','dashboard.search',
'dashboard.toggle_signin','users.index','users.create','users.store','users.edit',
'users.update','users.destroy','schedules.index','schedules.create','schedules.store',
'schedules.show','schedules.edit','schedules.update','schedules.destroy','attendances.index',
'attendances.create','attendances.store','attendances.show','attendances.update','attendances.destroy',
'reports.index','reports.chart','profile.edit','profile.update',
'profile.destroy','password.edit','password.update','appearance.edit','two-factor.show',
'register','register.store','password.request','password.email','password.reset',
'password.store','verification.notice','verification.verify','verification.send','storage.local',);
